...
public class WeatherContract {
    ...
    //to the relationship between a domain name and it's website.

    public static final String CONTENT_AUTHORITY = "com.example.bfinerocks.sunshine.app";

    //Use CONTENT_AUTHORITY to create a base for all URI's which apps will use to
